...
<script>
    $(document).ready(function () {
        // Inisialisasi validasi form menggunakan jQuery Validate
        $("#form-tambah").validate({
            ...
            submitHandler: function (form) {
                // Mengirim data form secara AJAX
                $.ajax({
                    url: form.action,
                    type: form.method,
                    data: $(form).serialize(),
                    success: function (response) {
                        if (response.status) {
                            ...
                            // Reload DataTable barang (pastikan dataBarang global sudah dideklarasikan di view index)
