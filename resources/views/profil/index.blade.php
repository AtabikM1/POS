        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-5 border-right text-center">
                    ...
                    <div class="mb-3">
                        @if (auth()->user()->foto_profil)
                            <img src="{{ asset(auth()->user()->foto_profil) }}" alt="Foto Profil"
                                class="img-circle elevation-3 mb-2" style="width: 180px; height: 180px; object-fit: cover;">
                        @else
                            <img src="{{ asset('default-avatar.png') }}" alt="Default Foto" class="img-circle elevation-3 mb-2"
                    ...
                    <div class="mt-3">
                        <img id="preview" src="#" alt="Preview" class="img-circle elevation-1 border border-secondary"
