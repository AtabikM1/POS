            ...
            <form action="{{ url('/supplier/' . $supplier->supplier_id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="supplier_kode" id="supplier_kode" class="form-control"
                        value="{{ old('supplier_kode', $supplier->supplier_kode) }}" placeholder="Masukkan kode supplier">
                </div>
                <div class="form-group">
                    <label for="supplier_nama">Nama Supplier</label>
                    <input type="text" name="supplier_nama" id="supplier_nama" class="form-control"
                        value="{{ old('supplier_nama', $supplier->supplier_nama) }}" placeholder="Masukkan nama supplier">
                </div>
                <div class="form-group">
                    <label for="supplier_alamat">Alamat</label>
                    <textarea name="supplier_alamat" id="supplier_alamat" class="form-control" rows="3"
                        placeholder="Masukkan alamat supplier">{{ old('supplier_alamat', $supplier->supplier_alamat) }}</textarea>
                </div>
                <div class="form-group">
